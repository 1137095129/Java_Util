...
public class TreeUtil {
	 ...
	 */
	public static <T> List<T> getTree(List<T> list, String childrenFieldName, String parentFieldName, String nextParentFieldName, Object parentId, Class<T> clazz) throws IllegalAccessException, InstantiationException, InvocationTargetException, NoSuchFieldException, NoSuchMethodException {
...
//					当属性名和传入的存储子节点的属性名一直时，此时生成对应的子节点
						...
						temp.remove(t);
						setMethod.invoke(t1, getTree(temp, childrenFieldName, parentFieldName, nextParentFieldName, clazz.getMethod(nextParentMethodName).invoke(t), clazz));
					}
				}
				resList.add(t1);
			}
